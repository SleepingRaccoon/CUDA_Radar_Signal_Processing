/*
============================================================
conv1d_sim.cu -- 1D linear convolution via FFT, SIMPLE plan API

A teaching rewrite of the NVIDIA cuda-samples example
"simpleCUFFT" (4_CUDA_Libraries/simpleCUFFT), using the simple
plan API: cufftPlan1d.
Copyright (c) 2022, NVIDIA CORPORATION.

Build:
  nvcc -o .\output\FFT\FFT1d\conv1d_sim.exe .\demo\FFT\FFT1d\conv1d_sim.cu -lcufft -Xcompiler /utf-8
Run:
  .\output\FFT\FFT1d\conv1d_sim.exe > .\output\FFT\FFT1d\conv1d_sim.txt
============================================================
*/
...
int main(void) {
    ...
    if (cufftPlan1d(&plan, FFT_LEN, CUFFT_C2C, 1) != CUFFT_SUCCESS) {
